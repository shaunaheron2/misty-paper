...
format:
  poster-typst:
    ...
    departments: "Schools of Psychology & Engineering and Computer Science"
    institution-logo: "./images/lu-iamgold6.pdf"
    footer-text: "This work was supported by IAMGOLD President’s Innovation Fund (Grant No. 2025-20377)."
    footer-emails: "sheron@laurentian.ca"
    footer-color: "ebcfb2"
    footer-logo: #"./images/IAMGOLD-Logo-N.png"
...
- **+18 points on Experienced Trust** (TI-HRC), p = .004 (affective, embodied trust formed during interaction)
- **+17 points on Perceived Trust** (TPS-HRI), p = .022 (retrospective reliability judgements)
- Both effects held after controlling for baseline robot attitudes (NARS)
- Effects were **independent of task accuracy** (p = .47)
:::

![Distribution of Trust Perception by interaction policy. Points represent individual observations; violins depict score distributions. Red points indicate group means with 95% confidence intervals.](./images/fig-post-eligible-1.pdf){width="80%"}
