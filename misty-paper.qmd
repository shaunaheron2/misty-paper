...
All self-report scales demonstrated acceptable to strong internal consistency in the present sample. The Negative Attitudes Toward Robots scale (NARS) showed good reliability (α = .81), with subscale alphas ranging from .72 to .76. The Need for Cognition scale (NFC) demonstrated strong internal consistency (α = .87). Both post-interaction trust measures also exhibited high reliability. The Trust Perception Scale–HRI (TPS-HRI) showed strong internal consistency overall (α = .89), with subscale reliabilities ranging from .74 to .88. The Trust in Industrial Human–Robot Collaboration scale (TI-HRC) demonstrated very high internal consistency (α = .95). 
