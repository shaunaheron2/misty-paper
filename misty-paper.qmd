...
In the full sample (N = 29), the difference between conditions did not reach conventional significance (p = .15). However, when analyses were restricted to sessions in which communication viability was sufficient to support the intended collaborative interaction (N = 24), condition differences were significant (p < .05).
