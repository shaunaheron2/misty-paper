...
Three features distinguish this study from the broader HRI trust literature. First, the entire interaction was managed fully autonomously: no human operator performed any portion of speech recognition, dialogue management, or response selection, exposing participants to authentic ASR errors, response latencies, and misinterpretations of the kind that characterize deployed autonomous systems rather than controlled laboratory simulations. Second, speech-channel viability varied naturally across sessions as a direct consequence of real-world ASR constraints, making it an empirically observable variable—one that is structurally inaccessible in WoZ paradigms, where operator-mediated speech comprehension absorbs such failures before they affect the interaction. Third, the affect-responsive policy was implemented as a property of an integrated autonomous system—coordinating dialogue management, affect inference, and task-state tracking in real time—rather than as a surface-level scripted behaviour or isolated manipulation. Together, these features position the study to examine trust dynamics under conditions that more closely approximate real-world deployment than prior paradigms relying on WoZ control, scripted dialogue, or idealized communication channels.
o
Rather than optimizing for flawless interaction, this pilot study prioritizes feasibility assessment and mechanism exploration over confirmatory hypothesis testing. The sample size is modest, interaction conditions subject to real-world autonomy constraints, and final condition assignment was not fully randomized due to participant attrition. Accordingly, results should be interpreted against the directional predictions outlined below as exploratory evidence regarding how interaction policy shapes trust under autonomous spoken-language collaboration, and as guidance for the design of larger, confirmatory studies. The findings are intended to inform the design of a larger subsequent study by evaluating feasibility and identifying technical, interactional, and methodological challenges that must be addressed when evaluating affect-responsive robots in real-world contexts.
...
**P1: Responsive interaction and trust.** Participants interacting with the responsive robot were expected to report higher post-interaction trust than those in the neutral, reactive condition. This prediction follows directly from prior work linking affect-aware and proactive robot behaviour to perceptions of trustworthiness, competence, and collaborative quality [@birnbaum2016; @shayganfar2019; @fartook2025].
...
![Experimental procedure and analytic sample determination. NARS = Negative
Attitudes Toward Robots Scale; NFC-s = Need for Cognition (short form); TI-HRC
= Trust in Industrial Human–Robot Collaboration scale; TPS-HRI = Trust
Perception Scale – Human–Robot Interaction; ASR = automatic speech
...
Trust in human-robot interaction is widely recognized as multidimensional, encompassing perceptions of reliability and competence as well as affective comfort and perceived collaboration [@lee2004; @devisser2020]. The use of two validated trust measures in the present study allowed these components to be examined in parallel. Rather than treating trust as a static attribute of the system, the results suggest that it functioned as an evaluation of the collaborative experience as it unfolded over time. Notably, a tentative pattern emerged in which the experienced trust measure (TI-HRC) appeared more sensitive to interaction degradation than the perceived trust measure (TPS-HRI), which is consistent with the conceptual distinction between these instruments but should be interpreted cautiously given the sample size and the absence of a formally validated multidimensional measurement model in this context.
