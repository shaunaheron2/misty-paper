...
format:
  elsevier-pdf:
    ...
    journal:
      name: Journal Name
      formatting: preprint #doubleblind #preprint #doubleblind
...
**P2: Responsive interaction and collaborative performance.** Participants in the responsive condition were expected to show a performance advantage on tasks requiring sustained robot collaboration. This prediction follows from research suggesting that affective cues and proactive support promote mutual grounding and smoother task coordination [@emaminejad2022; @lin2022]. Critically, this effect was expected to be contingent on task structure: enforced collaboration tasks, where participants must rely on the robot to progress, were expected to benefit more from responsive interaction than optional collaboration tasks, where participants can complete the task independently regardless of robot behaviour.
...
Across analytic approaches, the responsive interaction policy was associated with higher post-interaction trust compared to a neutral, reactive control policy when interaction remained viable. These differences emerged without reliable differences in overall task accuracy. Although the robot-dependent task showed a descriptive advantage for the responsive condition (30% vs. 64% correct), this effect did not reach statistical significance in the present pilot sample, likely reflecting limited power rather than a true null effect given the magnitude of the observed difference. Taken together, this pattern suggests that trust judgments were shaped more strongly by the quality and tone of the interaction process than by instrumental task success alone -- consistent with P1 and directionally consistent with P2, as specified in the Theoretical Rationale. This aligns with theoretical accounts that conceptualize trust as an emergent property of interaction dynamics rather than a static attribute of the system or a simple function of performance outcomes [@lee2004; @devisser2020].

Several theoretical mechanisms may account for why responsive interaction produced higher trust independent of task accuracy. From a social presence perspective, proactive engagement cues -- including unsolicited offers of assistance, empathic acknowledgment of participant state, and collaborative dialogue orientation -- signal that the robot is monitoring and responding to the user as a social partner rather than merely as a task executor [@birnbaum2016; @shayganfar2019]. This perceived attentiveness is associated with affective evaluations of trustworthiness and benevolence in human-agent interaction, independent of task outcome [@birnbaum2016]. Social exchange accounts offer a complementary explanation: unsolicited assistance constitutes a form of investment in the collaboration, and participants may have responded by extending reciprocal trust -- attributing cooperative intent to a robot that proactively supported them without being asked [@fartook2025]. Proactive dialogue also facilitates the mutual grounding necessary for participants to feel understood and coordinated with their robotic partner. When participants perceive the robot as accurately tracking their task state and emotional engagement, this supports both competence-based trust (the robot knows what it's doing) and rapport-based evaluations (the robot is working with me). These mechanisms are consistent with the process-oriented framing underlying P1: responsiveness operates not as a single cue but as a policy-level property that continuously updates the participant's evaluation of the robot's intent, capability, and collaborative orientation throughout the session.

Trust in human-robot interaction is widely recognized as multidimensional, encompassing perceptions of reliability and competence as well as affective comfort and perceived collaboration [@lee2004; @devisser2020]. The use of two validated trust measures in the present study allowed these components to be examined in parallel. Rather than treating trust as a static attribute of the system, the results suggest that it functioned as an evaluation of the collaborative experience as it unfolded over time. Both instruments showed the responsive advantage under viable interaction, supporting P1 convergently. A tentative pattern in which the experienced trust measure (TI-HRC) appeared somewhat more sensitive to interaction degradation than the perceived trust measure (TPS-HRI) is consistent with the conceptual distinction between these instruments, but we do not formally test this difference: the present sample is underpowered and lacks a validated multidimensional measurement model.

These differences became particularly apparent under conditions of reduced communication viability, and the pattern of attenuation provides insight into the mechanism underlying the main effect. When speech recognition failures accumulated and conversational grounding could not be re-established, the trust advantage associated with responsiveness diminished substantially. This moderation can be understood mechanistically in terms of what affect-responsive policies require to function: they depend on an intact dialogue channel to perceive user state, infer affect, and generate contextually appropriate proactive responses. When the speech channel degrades, the robot’s affect inference and task-state tracking break down, severing the feedback loop through which responsiveness is expressed. In this degraded state, the responsive policy continued generating proactive and engagement-oriented outputs -- but without accurate perception of user state, these outputs were increasingly mismatched to the actual interaction context. Proactive assistance or empathic framing generated in response to misrecognized input may be experienced as incoherent or unreliable, potentially amplifying the negative effects of communication failure rather than offsetting them. By contrast, the neutral, reactive policy -- which makes fewer inferential demands on the speech channel and generates fewer unsolicited responses -- is more robust to degraded input. This differential robustness explains why the trust gap narrowed specifically under communication failure: it was not simply that both conditions deteriorated in parallel, but that the communicative infrastructure the responsive policy requires to express itself was unavailable, while the neutral policy’s more restrained style remained serviceable. Affect-responsive policies thus operate within a communication viability window -- below that threshold, the adaptive machinery cannot function as intended, and the policy’s characteristic behaviours may become a source of coordination burden rather than trust support. This boundary condition has direct implications for deployment: systems employing affect-responsive policies should incorporate explicit communication monitoring and graceful degradation strategies to limit this failure mode in real-world settings. Taken together, this pattern is consistent with the exploratory analyses reported under the P2-adjacent communication breakdown analysis and provides a mechanistic account of why dialogue continuity is a prerequisite for the trust benefits of responsiveness.
