...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TODO}, coltitle=black, leftrule=.75mm, left=2mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, breakable, opacityback=0, colframe=quarto-callout-important-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TO DO:}, coltitle=black, leftrule=.75mm, left=2mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, breakable, opacityback=0, colframe=quarto-callout-important-color-frame]
