...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TODO}, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, leftrule=.75mm, breakable, bottomrule=.15mm, bottomtitle=1mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-important-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TO DO:}, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, leftrule=.75mm, breakable, bottomrule=.15mm, bottomtitle=1mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-important-color-frame]
