...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TODO}, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, opacityback=0, arc=.35mm, bottomrule=.15mm, coltitle=black, left=2mm, rightrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{TO DO:}, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, toprule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, opacityback=0, arc=.35mm, bottomrule=.15mm, coltitle=black, left=2mm, rightrule=.15mm, leftrule=.75mm]
