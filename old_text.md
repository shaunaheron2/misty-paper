...
## Communication viability and sample definition

Before hypothesis testing, sessions were classified based on communication viability using a dialogue-level metric derived from system logs and manual coding. Sessions in which more than 50% of dialogue turns were characterized by speech-recognition failure or fragmented utterances were classified as non-viable. This criterion closely matched sessions independently flagged during administration and reflects cases in which sustained spoken-language interaction was not possible. These classifications were used solely to define analytic samples and were not based on trust outcomes or task performance.

## Primary Analsysis: Eligible Sample

## Sensitivity Analysis: Full Sample

## Mechanism Analysis: communication breakdown and failure modes
